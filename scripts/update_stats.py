...
SUMMARY_OUTPUT = DATA_DIR / "nightly_summary.json"
DAILY_OUTPUT = DATA_DIR / "daily_article.json"
SCHEDULE_OUTPUT = DATA_DIR / "today_schedule.json"
TRANSACTIONS_OUTPUT = DATA_DIR / "transactions.json"
...
def build_today_schedule():
    ...
    try:
        data = get_json("https://statsapi.mlb.com/api/v1/schedule", {
            "sportId": 1, "date": today, "hydrate": "team"
        })
        by_team = {}
        game_cache = {}
